...
const DashboardCrypto = () => {
  ...
  const forGettingAllOrdersOfRestaurent = async () => {
    ...
    try {
      ...
      if (response.ok) {
        console.log("ok data", data.myFilterOrders);
        setAllOrders(data.myFilterOrders);
        setFilterOrders(data.myFilterOrders);
      } else {
                    ...
                    <td>
                      {(() => {
                        ...
                        if (paymentMethods.length === 1) {
                          ...
                          return "No Charge"; // Fallback if no payment method exists
                        }
                      })()}
                    </td>
