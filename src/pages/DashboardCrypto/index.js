  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb invoiceText="Invoice Managment" />
          <div>
            <div className="d-flex justify-content-between align-items-center mb-3 ">
              <h5 className="bg-light-dark mt-2 mb-4">Invoice</h5>
              <div>
                <Button className=" btn-primary text-white px-2 mx-1 py-2 border-none">
                  <i className="ri-search-line align-bottom me-1"></i>
                  search
                </Button>
                <Button className="add-btn btn-warning text-white px-3 py-2 mx-1 border-none">
