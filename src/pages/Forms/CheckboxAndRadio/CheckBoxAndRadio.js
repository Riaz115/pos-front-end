...
const CheckBoxAndRadio = () => {
  document.title =
    "Checkbox & Radio | Velzon - React Admin & Dashboard Template";
                      ...
                      <Col lg={4} md={6}>
                        <div>
                          ...
                          <p className="text-muted">
                            ...
                            checkbox and add <code>checked</code> attribute to
                      ...
                      <Col lg={4} md={6}>
                        <div className="mt-4 mt-md-0">
                          ...
                          <p className="text-muted">
                            ...
                            checkbox disabled and add <code>checked</code>{" "}
                      ...
                      <Col lg={4} md={6}>
                        <div>
                          ...
                          <p className="text-muted">
                            ...
                            radio button and add <code>checked</code> attribute
                            to set a radio checked by default.
                          </p>
                          <div className="form-check mb-2">
                            <Input
                              className="form-check-input"
                    ...
                    <Row>
                      <Col lg={4} md={6}>
                        <div>
                          ...
                          <p className="text-muted">
                            ...
                            class to set a switch and add <code>checked</code>{" "}
                      ...
                      <Col lg={4} md={6}>
                        <div className="mt-4 mt-md-0">
                          ...
                          <p className="text-muted">
                            Use <code>disabled</code> attribute to set a radio
                            button disabled and add <code>checked</code>{" "}
                            attribute to set a switch checked by default.
                          </p>
                          <div className="form-check form-switch mb-2">
                            <Input
