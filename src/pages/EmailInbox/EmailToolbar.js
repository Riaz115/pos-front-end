...
import allStatesForTimeZone from "./allStatesForTimeZone";
        ...
        <Modal isOpen={showModal} toggle={toggleModal} centered>
          ...
          >
            {restLogo ? (
              ...
              "NO IMAGE FOUND PLEASE UPLOAD IMAGE"
            )}
          </ModalBody>
          <ModalFooter>
