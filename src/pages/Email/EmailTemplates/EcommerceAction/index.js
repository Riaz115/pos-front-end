...
const index = () => {
  ...
  const forTransfarTable = async () => {
    if (forCatchErrors()) {
      const url = `${myUrl}/transfar/table/${selectedTableId}/${targetTableId}/save/table`;
      const options = {
        method: "POST",
        headers: {
          ...
          <Row className="p-0">
            <Col lg={6}>
              <Row>
                <div className="col-8">
                  <Row className="my-3">
                    <h6>Select Table to Transfar</h6>
            ...
            <Col lg={6}>
              <div className="col-8">
                <Row className="my-3">
                  <h6>Select Table to Transfar With Table</h6>
